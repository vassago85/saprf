            ...
            <div class="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                ...
                <form method="POST" action="{{ url('/events/' . $match->id . '/register') }}" class="p-6 space-y-6">
                    ...
                    <div class="rounded-xl border border-stone-200 p-4 space-y-3">
                        <h3 class="text-sm font-semibold text-stone-700">Your Registration</h3>
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-stone-600">{{ auth()->user()->name }}</p>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        ...
                        <button type="submit"
                            ...
                            Confirm Registration — R {{ number_format($pricing['fee'], 2) }}
                        </button>
                    </div>
                </form>
            </div>
