<x-layouts.guest>
    <x-slot:title>Payment Cancelled - SAPRF</x-slot:title>
    ...
    <div class="bg-stone-50 min-h-screen flex items-center justify-center">
        <div class="max-w-md mx-auto px-4 py-16 text-center">
            <div class="bg-white rounded-2xl border border-stone-200 shadow-sm p-8 space-y-6">
                <div class="mx-auto size-14 rounded-full bg-amber-100 flex items-center justify-center">
                    <svg class="size-7 text-amber-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                    </svg>
                </div>

                <div>
                    <h1 class="font-heading text-2xl font-bold text-stone-900">Payment Cancelled</h1>
                    <p class="mt-2 text-sm text-stone-500">Your payment was cancelled. No charge has been made. Your registration is still saved and you can pay later.</p>
                </div>
