...
new #[Layout('components.layouts.guest')] #[Title('Reset Password — SAPRF')] class extends Component {
    public string $token = '';
    public string $email = '';
...
<div class="flex min-h-screen items-center justify-center px-4 bg-stone-50">
    <div class="w-full max-w-md">
        ...
        <div class="rounded-xl border border-stone-200 bg-white shadow-sm p-8">
            <h1 class="font-heading text-2xl font-bold text-stone-900 mb-1">Reset Password</h1>
            ...
            <form wire:submit="resetPassword" class="space-y-5">
                ...
                <x-password-field wire:model="password" id="password" label="New Password" :required="true" :min="8">
