            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2" x-data="{ matchType: '{{ old('match_type', '') }}' }">
                ...
                <div>
                    ...
                    <select name="series_level" id="series_level" required class="block w-full rounded-lg border border-stone-300 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <option value="international" @selected(old('series_level') === 'international')>International</option>
                    </select>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="junior_fee" id="junior_fee" step="0.01" min="0" value="{{ old('junior_fee') }}" placeholder="Leave blank = same as entry fee" class="block w-full rounded-lg border border-stone-300 text-sm focus:ring-emerald-500 focus:border-emerald-500" />
