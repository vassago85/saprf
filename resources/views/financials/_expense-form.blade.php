...
<div class="space-y-5 max-w-2xl">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
            <label for="vendor" class="block text-sm font-medium text-stone-700 mb-1">Vendor / Supplier</label>
    ...
    <div>
        <label for="reference" class="block text-sm font-medium text-stone-700 mb-1">Reference / Invoice #</label>
