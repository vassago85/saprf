    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-stone-500">Update {{ $rifle->nickname }} configuration.</p>
            </div>
            <a href="{{ route('rifle-configurations.show', $rifle) }}" class="text-sm text-emerald-700 font-medium hover:text-emerald-800">&larr; Back to Rifle</a>
        </div>
        ...
        <form method="POST" action="{{ route('rifle-configurations.update', $rifle) }}"
            x-data="{
                makeId: '{{ old('firearm_make_id', $rifle->firearm_make_id) }}',
                models: [],
                modelId: '{{ old('firearm_model_id', $rifle->firearm_model_id) }}',
                async loadModels() {
            ...
            x-init="await loadModels(); modelId = '{{ old('firearm_model_id', $rifle->firearm_model_id) }}';"
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nickname" id="nickname" value="{{ old('nickname', $rifle->nickname) }}" required
                ...
                <div>
                    ...
                    <select name="firearm_make_id" id="firearm_make_id" required
                        x-model="makeId" @change="loadModels(); modelId = '';"
                        class="w-full rounded-lg border-stone-300 text-sm py-2.5 px-3 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div>
                    ...
                    <select name="calibre_id" id="calibre_id" required
                        ...
                        @foreach ($calibres as $calibre)
                            <option value="{{ $calibre->id }}" @selected(old('calibre_id', $rifle->calibre_id) == $calibre->id)>{{ $calibre->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="optic_description" id="optic_description" value="{{ old('optic_description', $rifle->optic_description) }}"
                ...
                <div>
                    ...
                    <input type="text" name="bullet_description" id="bullet_description" value="{{ old('bullet_description', $rifle->bullet_description) }}"
                ...
                <div>
                    ...
                    <input type="text" name="barrel_length" id="barrel_length" value="{{ old('barrel_length', $rifle->barrel_length) }}"
                        placeholder='e.g. 26"'
                        class="w-full rounded-lg border-stone-300 text-sm py-2.5 px-3 focus:ring-emerald-500 focus:border-emerald-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="twist_rate" id="twist_rate" value="{{ old('twist_rate', $rifle->twist_rate) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                        class="w-full rounded-lg border-stone-300 text-sm py-2.5 px-3 focus:ring-emerald-500 focus:border-emerald-500">{{ old('notes', $rifle->notes) }}</textarea>
                </div>

                <div class="sm:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_primary" value="1"
                            @checked(old('is_primary', $rifle->is_primary))
            ...
            <div class="flex items-center gap-4 pt-2">
                ...
                <a href="{{ route('rifle-configurations.show', $rifle) }}" class="text-sm text-stone-500 hover:text-stone-700">Cancel</a>
            </div>
        </form>
    </div>
</x-layouts.app>
