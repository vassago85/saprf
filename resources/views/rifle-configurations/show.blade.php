    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <form method="POST" action="{{ route('rifle-configurations.destroy', $rifleConfiguration) }}" class="inline"
                    ...
                    @method('DELETE')
                    <button type="submit"
                        class="inline-flex items-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm font-semibold text-red-700 hover:bg-red-50 transition">
