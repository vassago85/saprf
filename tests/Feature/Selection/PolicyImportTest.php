...
it('imports the PR22 v1.4 policy JSON and marks it active on the cycle', function () {
...
it('is idempotent: re-import of the same file updates in place', function () {
    ...
    $first = $svc->import(base_path('docs/selection/pr22/2026/policy.json'), $cycle);
    $second = $svc->import(base_path('docs/selection/pr22/2026/policy.json'), $cycle);
