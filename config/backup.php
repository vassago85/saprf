...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             *
             * The R2 disk is auto-included only when R2 credentials are
             * present in the environment. Local fallback is always on.
             */
            'disks' => array_values(array_filter([
                'local',
                env('R2_ACCESS_KEY_ID') && env('R2_BUCKET') ? 'r2' : null,
            ])),
