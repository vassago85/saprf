...
class RifleConfigurationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'muzzle_brake_description' => ['nullable', 'string', 'max:255'],
            'bipod_description' => ['nullable', 'string', 'max:255'],
            'magazine_description' => ['nullable', 'string', 'max:255'],
            'tripod_description' => ['nullable', 'string', 'max:255'],
            'brass_description' => ['nullable', 'string', 'max:255'],
            'powder_description' => ['nullable', 'string', 'max:255'],
            'rangefinder_description' => ['nullable', 'string', 'max:255'],
            'gunsmith_description' => ['nullable', 'string', 'max:255'],
            'scope_mount_description' => ['nullable', 'string', 'max:255'],
            'bag_description' => ['nullable', 'string', 'max:255'],
            'chronograph_description' => ['nullable', 'string', 'max:255'],
